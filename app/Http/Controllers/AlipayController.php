...
class AlipayController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->return_url = env('ALIPAY_RETURN_URL');//同步通知地址
        $this->rsaPrivateKeyFilePath = storage_path('key/alipayprivate.pem');    //应用私钥
        $this->aliPubKey = storage_path('key/alipay.key'); //支付宝公钥
    }
...
//        }
        ...
        $bizcont = [
            ...
            'out_trade_no'      => $oid,
            'total_amount'      => $order_info['order_price'] / 100,
    ...
    protected function sign($data) {
        $priKey = file_get_contents($this->rsaPrivateKeyFilePath);//私钥
//        dump($priKey);die;
